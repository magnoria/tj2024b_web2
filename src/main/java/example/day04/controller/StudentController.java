...
public class StudentController {
    ...
    public boolean save(@RequestBody StudentDto studentDto ){ // { "name" : "유재석" , "kor" : "90" , "math" : "100" }
    ...
    public boolean update(@RequestBody StudentDto studentDto ){ // { "sno" : "1" , "name" : "유재석" , "kor" : "90" , "math" : "100" }
