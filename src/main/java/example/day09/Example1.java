...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        MemberDto memberDto = new MemberDto( "유재석" , 40); // 존재하지 않은 생성자 사용
//        MemberDto memberDto1 = new MemberDto();// 존재하지 않은 생성자 사용.
//        MemberDto memberDto2 = new MemberDto("유재석"); // 정의된 생성자 없어서// 정의된 생성자의 매개변수를 일치하지 않아서
...
//        MemberDto memberDto4 = new MemberDto("유재석" , 40 , "연예인"); // 정의된 생성자가 없어서 // 정의된 생성자의 매개변수를 일치하지 않아서
        ...
        // (2) 룸복에서 제공하는 @Builder 어노테이션 객체 생성
