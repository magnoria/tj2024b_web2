...
import axios from 'axios';
    ...
    export default function Example1(props){
        ...
        const onEvent3 =async () => {
            ...
            console.log('========================2[GET]=============================')
            const response2 = await axios.get('https://jsonplaceholder.typicode.com/posts/1') //매개변수 보내기 : path variavle 방식
            console.log(response2.data);
            console.log('==========================3[GET]============================')
            const response3 = await axios.get('https://jsonplaceholder.typicode.com/comments?postId=1')// 매개변수보내기 : queryString
            console.log(response2.data);
        }
        //[4] axios post test
        const onEvent4 = async () => {
            const obj = {userId : 1 , title : 'foo' , body : 'bar'}
            const response1 = await axios.post('https://jsonplaceholder.typicode.com/posts', obj)// 매개변수보내기 : body 방식(JOSN) 방식
            console.log(response1.data);
        }
        //[5] axios put test
        ...
        return(<>
            ...
            <button type='button' onClick={ (e) => {onEvent2(13)}}> 이벤트 함수2</button>
